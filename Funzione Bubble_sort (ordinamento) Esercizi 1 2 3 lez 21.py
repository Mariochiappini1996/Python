# -*- coding: utf-8 -*-
"""
Created on Mon Aug 21 21:42:35 2023
...
# eseguito il ciclo esterno. Al massimo puÃ² essere eseguito n-1 volte.
# Nel caso peggiore il ciclo interno Ã¨ eseguito
# (n-1) + (n-2) +...+ 1 = O(n**2) che Ã¨ il costo dell'algoritmo nel caso peggiore.
...
def bubble_sort(a, inplace=True):
    ...
    Output: ordina le stringhe in a dalla piÃ¹ corta alla piÃ¹ lunga, ritorna la lista ordinata.
    	Se inplace Ã¨ True la funzione muta a, altrimenti viene restituita una nuova lista
...
# i numeri siano ordinati dal piÃ¹ piccolo al piÃ¹ grande,
...
#
# la funzione num_str se usata come parametro key assegna valori pÃ¹ piccoli ai numeri
# e piÃ¹ grandi alle stringhe. Quindi i numeri precederanno le stringhe. All'interno
# della sequenza dei numeri (o delle stringhe), verrÃ  utilizzato il valore, ovvero
